...
#define LIGHT_ID         "60b406b12a231603cf26559d"    // Should look like "5dc1564130xxxxxxxxxxxxxx"
#define BAUD_RATE         9600                // Change baudrate to your need
...
void handleLightState() {
    if (myLightState != lastLightState) {
      lastLightState = myLightState;
      //SinricProLight &myLight = SinricPro[Light_ID];   // create new light device
      //myLight.sendPowerStateEvent(myLightState);
      //Serial.printf("Light %s\r\n",  myLightState?"on":"off");
      //digitalWrite(LIGHT, !myLightState); 
    }
}
...
void handleMotionsensor() {
  ...
  if(actualMotionState && (!myLightState)) { // 
    lastLightState = myLightState;
    myLightState = true;
